class Neighborhood < ActiveRecord::Base
  ...
  def self.highest_ratio_res_to_listings
    ...
    Neighborhood.all.each do |neighborhood|
      ...
      ratio = neighborhood.listings.count > 0 ? reservation_count/neighborhood.listings.count : 0
      ratio_array = [neighborhood, ratio] if ratio > ratio_array[1]
    end
    ratio_array[0]
  end
  ...
  def self.most_res
    ...
    Neighborhood.all.each do |neighborhood|
      ...
      res_array = [neighborhood, reservation_count] if reservation_count > res_array[1]
    end
    res_array[0]
  end
