...
def make_reservations
  # first listing
  Reservation.create!(checkin: '2018-01-01', checkout: '2018-01-07', listing_id: 1, guest_id: User.last.id, :status => "accepted")
  Reservation.create!(checkin: '2018-01-09', checkout: '2018-01-20', listing_id: 1, guest_id: 5, :status => "accepted")
  Reservation.create!(checkin: '2018-04-25', checkout: '2018-04-30', listing_id: 1, guest_id: 4, :status => "accepted")
  # second listing
  Reservation.create!(checkin: '2018-03-10', checkout: '2018-03-25', listing_id: Listing.find(2).id, guest_id: User.find_by(id: 5).id, :status => "accepted")
  # last listing
  Reservation.create!(checkin: '2018-06-02', checkout: '2018-06-30', listing_id: Listing.last.id, guest_id: User.find(6).id, :status => "accepted")
  Reservation.create!(checkin: '2018-05-15', checkout: '2018-06-01', listing_id: Listing.last.id, guest_id: User.find(5).id, :status => "accepted")
end
